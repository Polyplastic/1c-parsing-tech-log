...
Процедура ЗаписатьДанныеВБезопасноеХранилище(Знач Владелец,Знач Данные, Знач Ключи = Неопределено) Экспорт
...
// Помещает настройки в безопасное хранилище
Процедура ЗаписатьДанныеВБезопасноеХранилищеРасширенный(Знач Владелец, Знач Данные, Знач Комментарий="", Знач Ключи = Неопределено) Экспорт
...
Функция ДанныеИзБезопасногоХранилища(Знач Владелец,Знач Ключи = Неопределено) Экспорт
