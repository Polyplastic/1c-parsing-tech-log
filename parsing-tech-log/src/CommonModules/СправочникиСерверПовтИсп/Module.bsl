...
Функция РеквизитыСвойства(ЗНАЧ Свойство) Экспорт
	РеквизитыСвойства = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Свойство, "НормализацияЗначения, ТекстФункцииНормализации, МногострочныйРежим, Хешировать, Числовое, Синоним, Процент");
