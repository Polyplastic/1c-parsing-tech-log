...
&НаКлиенте
Процедура ПолучитьСписокИнформационныхБаз(Команда)
	ПолучтьСписокНаКлиенте("infobase");
КонецПроцедуры


&НаКлиенте
Процедура ПолучитьСписокСоединений(Команда)
	ПолучтьСписокНаКлиенте("connection");
КонецПроцедуры

&НаКлиенте
Процедура ПолучитьСписокПроцессов(Команда)
	ПолучтьСписокНаКлиенте("process");
КонецПроцедуры
...
&НаКлиенте
Процедура ПолучитьСписокСерверов(Команда)
	ПолучтьСписокНаКлиенте("server");	
КонецПроцедуры

&НаКлиенте
Процедура ПолучитьСписокСеансовЛицензий(Команда)
	ПолучтьСписокНаКлиенте("session",Истина);		
КонецПроцедуры

&НаКлиенте
Процедура ПолучитьСписокПроцессовЛицензий(Команда)
	ПолучтьСписокНаКлиенте("process",Истина);			
КонецПроцедуры
...
Процедура ЗавершитьРаботуСенаса(Команда)
	...
	Для каждого стр из СтарыеКолонки Цикл
		Если стр.Заголовок="session" Тогда
