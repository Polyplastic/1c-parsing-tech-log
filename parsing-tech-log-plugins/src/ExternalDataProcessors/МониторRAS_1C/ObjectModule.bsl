...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Версия", "2019.12.03");
...
Процедура ДобавитьСвойстваСерверКластер(Знач парам_кластера, Знач СтруктураЗаписи)
	...
	СтруктураЗаписи.КлючевыеСвойства.Вставить(Свойство, парам_кластера.server+"("+парам_кластера.port_ras+")->"+парам_кластера.name);
