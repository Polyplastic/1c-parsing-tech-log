...
Процедура ПреобразоватьНаСервере(ОбновлятьТаблицы=Ложь)
	...
	Если НЕ ЭтоПланЗапроса=Истина Тогда
		Текст = СтрЗаменить(Текст,") T",") AS T");
	КонецЕсли;
	...
	Если ПреобразоватьНаРусский=Истина Тогда
		...
		Текст = СтрЗаменить(Текст,"UNION ALL","ОБЪЕДИНИТЬ ВСЕ");
		Текст = СтрЗаменить(Текст,"UNION","ОБЪЕДИНИТЬ");
		...
		Текст = СтрЗаменить(Текст,"HAVING","ИМЕЮЩИЕ");
		...
		Текст = СтрЗаменить(Текст,Символы.ПС+"AND ",Символы.ПС+" И ");
		Текст = СтрЗаменить(Текст,Символы.ПС+"AND"+Символы.ПС,Символы.ПС+" И "+Символы.ПС);
		Текст = СтрЗаменить(Текст," OR "," ИЛИ ");         
		Текст = СтрЗаменить(Текст,Символы.ПС+"OR ",Символы.ПС+" ИЛИ ");         
		Текст = СтрЗаменить(Текст,Символы.ПС+"OR"+Символы.ПС,Символы.ПС+" ИЛИ "+Символы.ПС);
		Текст = СтрЗаменить(Текст," ON "," ПО ");
		Текст = СтрЗаменить(Текст,Символы.ПС+"ON ",Символы.ПС+" ПО ");
		...
		Текст = СтрЗаменить(Текст,"MIN","МИНИМУМ");
		...
		Текст = СтрЗаменить(Текст,"InitialBalance","НачальныйОстаток"); 
		Текст = СтрЗаменить(Текст,"FinalBalance","КонечныйОстаток"); 
		Текст = СтрЗаменить(Текст,"Balance","Остаток"); 	
	КонецЕсли;
